...
import com.example.hp.journalapp.database.JournalEntry;
...
public class JournalAdapter extends RecyclerView.Adapter<JournalAdapter.JournalViewHolder> {
    ...
    public void onBindViewHolder(JournalViewHolder holder, int position) {
        ...
        String jour_content = journalEntry.getJournalContent();
        String jour_date = dateFormat.format(journalEntry.getJournalDate());

        //Set values
        holder.journalContent.setText(jour_content);
        holder.journalTime.setText(jour_date);
